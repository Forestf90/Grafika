...
//narysowanie obiektu - piramidy złożonej  z różnych obiektów(pełnych lub samych kontur) 15 poziomów piramidy + wybrać materiał piramidy
...
void Pyramid()
{
	//15x15
	glPushMatrix();
	glTranslatef(1.5, -1.5, -27.0);
	Dode15x15();
	glPopMatrix();
	//14x14
	glPushMatrix();
	glTranslatef(1.5, -1.5, -24.0);
	Dode14x14();
	glPopMatrix();
	//13x13
	glPushMatrix();
	glTranslatef(1.5, -1.5, -21.0);
	Dode13x13();
	glPopMatrix();
	//12x12
	glPushMatrix();
	glTranslatef(1.5, -1.5, -18.0);
	Dode12x12();
	glPopMatrix();
	//11x11
	glPushMatrix();
	glTranslatef(1.5, -1.5, -15.0);
	Dode11x11();
	glPopMatrix();
	//10x10
	glPushMatrix();
	glTranslatef(1.5, -1.5, -12.0);
	Dode10x10();
	glPopMatrix();

	//9x9
	glPushMatrix();
	glTranslatef(1.5, -1.5, -9.0);
	Dode9x9();
	glPopMatrix();
