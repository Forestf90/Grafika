...
front_standing = pygame.image.load('gameimages/departed_front.gif')
back_standing = pygame.image.load('gameimages/departed_back.gif')
left_standing = pygame.image.load('gameimages/departed_left.gif')
